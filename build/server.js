...
module.exports = {"appName":"app-000001","defaultPort":"3333","firebase":{"apiKey":"AIzaSyASBKmCUEjbS7Krp1O55xRldAFowf95UT0","authDomain":"acando-academy-codehub.firebaseapp.com","databaseURL":"https://acando-academy-codehub.firebaseio.com","projectId":"acando-academy-codehub","storageBucket":"acando-academy-codehub.appspot.com","messagingSenderId":"484704683824"}}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__appConfig_json__ = __webpack_require__("./appConfig.json");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__appConfig_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__appConfig_json__);





var fbConfig = __WEBPACK_IMPORTED_MODULE_3__appConfig_json___default.a.firebase;
var APP_NAME = __WEBPACK_IMPORTED_MODULE_3__appConfig_json___default.a.appName;

__WEBPACK_IMPORTED_MODULE_2_firebase__["initializeApp"](fbConfig);
...
var isProduction = Object({"BUILD_TARGET":"server"}) === 'production';

isProduction && app.set('port', Object({"BUILD_TARGET":"server"}).PORT || __WEBPACK_IMPORTED_MODULE_3__appConfig_json___default.a.defaultPort);

//get all items on the people node
app.get('/people', function (req, res) {
  var ref = __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref(APP_NAME);
  ref.once('value').then(function (snapshot) {
    var data = [];
    var peopleData = snapshot.val().people;
    Object.keys(peopleData).map(function (key) {
      var person = snapshot.val().people[key];
      person.key = key;
      data.push(person);
    });
    res.send(data);
...
app.post('/people/add', function (req, res) {
  var ref = __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref(APP_NAME + '/people');
  ref.push(req.body, function () {
